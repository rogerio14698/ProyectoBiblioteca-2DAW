...
@section('content')
    <!-- Página de error 503 personalizada. Cumple estándar AGENTS.md -->
    <main id="main-content" class="contenedorError" style="min-height: 60vh; display: flex; flex-direction: column; align-items: center; justify-content: center; background: var(--color-fondo-global);">
        <h1 style="color: var(--color-primario); font-size: 4rem; margin-bottom: var(--unidad-espaciado);">503</h1>
        <h2 style="color: var(--color-secundario); margin-bottom: var(--unidad-espaciado);">Sitio en mantenimiento</h2>
        <p style="color: var(--color-primario); margin-bottom: calc(var(--unidad-espaciado) * 2);">Estamos realizando tareas de mantenimiento. Vuelve a intentarlo en unos minutos.</p>
